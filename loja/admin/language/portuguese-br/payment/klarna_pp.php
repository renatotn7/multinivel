...
$_['entry_total']        = 'Total Mínimo:<br /><span class="help">Valor mínimo que o pedido deve atingir para que esta forma de pagamento seja oferecida ao cliente.</span>';
...
// Error
$_['error_permission']	 = 'Atenção: Você não possui permissão para modificar o módulo Klarna Part Payment!';
$_['error_xmlrpc']       = 'A extensão XML-RPC do PHP precisa está instalada em seu servidor para que o módulo funcione!';
