	...
	public function genTree( $parent, $level ){
		if( $this->hasChild($parent) ){
			...
			foreach( $data as $menu ){
				...
				<div><span class="disclose"><span></span></span>'.($menu['title']?$menu['title']:"").' (ID:'.$menu['megamenu_id'].') <span class="quickedit" rel="id_'.$menu['megamenu_id'].'">E</span><span class="quickdel" rel="id_'.$menu['megamenu_id'].'">D</span></div>';
