...
<div id="content"><?php echo $content_top; ?>
    ...
    <table class="list">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="right"><?php echo $product['reward']; ?></td>
        ...
        <tfoot>
            <tr>
                <td></td>
                <td class='right'>Total produtos:</td>
                <td class='right'><?php echo $totalQuanty; ?></td>
                <td class='right'><?php echo $totalReward; ?></td>
                <td></td>
                <td></td>
                <td></td>
            </tr>
    ...
    <div class="buttons">
        ...
        <?php if ($check_payment_method == 1 ){?>   
  		<?php if ( $order_status == 1 ) { ?>
	               <div class="right"><a href="<?php echo $rebillet; ?>" class="button" target="_blank"><?php echo $button_rebillet; ?> </a></div>
		<?php  } ?>
        <?php }?>  
    </div>
