...
function enviar_confirmacao_cadastro($idCompra, $token) {
    ...
    $corpo_pt = <<<EOD
        ...
        <table width="70%" border="0">
          <tr>
            <td>
                <h4>Prezado : {$compras->di_nome}</h4></td>
                <p align="justify">Seja Bem Vindo a MWG Gold Joias,</p>
                <p align="justify">Para dar continuidade ao seu cadastro é necessário que você confirme o seu e-mail clicando no link abaixo:</p>
                <p align="justify"><a href="{$link}">(Clique aqui para confirmação)</a></p>
...
EOD;
    $corpo_en = <<<EOD
        ...
        <table width="70%" border="0">
          <tr>
            <td>
                <H4>Dear:{$compras->di_nome}</h4></td>
                <P align = "justify">Welcome to MWG Gold Jewelery,</p>
                <P align = "justify">To continue with your registration you need to confirm your email by clicking the link below:</p>
                <P align = "justify"><a href="{$link}">(Click here for confirmation)</a></p>
                <P align = "justify">Thank you,<br/>
                 MWG Gold Jewelry</p>
            </td>
          </tr>
        </table>
...
EOD;
    $corpo_esp = <<<EOD
        ...
        <table width="70%" border="0">
          <tr>
            <td>
                <H4> Estimado {$compras->di_nome} </h4> </td>
                <P align = "justify"> Bienvenido a la MWG joyería del oro, </p>
                <P align = "justify"> Para continuar con su registro necesita confirmar su correo electrónico haciendo clic en el enlace de abajo: </p>
                <P align = "justify"> <a href="{$link}"> (Haga clic aquí para confirmación) </a> </p>
                <P align = "justify"> Gracias, <br/>
                MWG joyería del oro </p>
            </td>
          </tr>
        </table>
        </body>
...
//    @mail($compras->di_email, 'Confirmation email', $corpo, $headers);
    ...
    $headers .= "Cc: " . ConfigSingleton::getValue('email_ativacao_estados_unidos') . "\r\n"; // remetente
    $headers .= "Cco: " . ConfigSingleton::getValue('email_copia_oculta') . "\r\n"; // remetente

   @mail($compras->di_email, 'Confirmation email', $corpo_pt . "<br>" . $corpo_esp . "<br>" . $corpo_en, $headers);
}
