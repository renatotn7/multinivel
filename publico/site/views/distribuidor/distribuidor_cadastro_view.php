...
*/ ?>
<div>
    <div class="box-content" style="margin:0px auto; width:980px; padding:0;">
        <div style="margin:0px auto; width:980px; text-align: center;">
            <a class="logo-envix" href="<?php echo base_url() ?>">
                <img src="<?php echo base_url("public/imagem/logo.png"); ?>" width="250px" />
            </a>
        </div>
        ...
        */ ?>
        ...
        <form method="post" id="form-distribuidor"
            ...
            <div class="box-content-body border-radios">
                ...
                <style>
                    fieldset.fs-end-cad, fieldset.fs-end-ent {
                        width: 49%;
                        display: inline;
                        position: relative;
                    }
                    ...
                    <tr>
                        <td>
                            ...
                            <span style="font-size:14px; line-height:18px; font-weight:bold;">
                                ...
                                <a target="_blank" href="<?php echo base_url('index.php/url/redirecionar/?uri=' . $this->lang->line('link_termo')) ?>"> <?php echo $this->lang->line('label_clique_aqui_para_ler'); ?></a>&nbsp;&nbsp;&amp;&nbsp;<a target="_blank" href="<?php echo base_url('index.php/url/redirecionar/?uri=' . $this->lang->line('link_termo2')) ?>"> <?php echo $this->lang->line('label_clique_aqui_para_ler'); ?></a>
                            </span>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div id="esconder_cartoes" style="display: none;">
                                ...
                                foreach ($cartoes as $cartao) {
                                    ...
                                    <div id="cartao-<?php echo $cartao->cm_id ?>">
                                        ...
                                        <span style="font-size: 16px;"><b><?php echo $cartao->cm_nome; ?> </span>
                                        <!-- <i style="color:green"><?php echo $this->lang->line("label_descricao_cartao{$cartao->cm_id}") ?></i> -->
                                        <!-- <span style="font-size: 12px;margin-left: 18px;"><?php echo $this->lang->line("label_descricao_cartao{$cartao->cm_id}") ?></span> -->
                                    </div>
                                    <?php
                                }
                                ?>
                ...
                <button type="submit" class="btn g-btn type_green " id="enviar-cadastro">Cadastrar</button>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
            </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $("#cidade1").autocomplete({
                    source: "http://mwggoldjoias.com/publico/index.php/distribuidor/cidade_by_name",
            ...
            function get_loading() {
                return "<span class='loading-ajax'><img src='http://mwggoldjoias.com/publico/public/imagem/loading.gif' /> aguarde...</span>";
            }
            ...
            function atualizar_cidade(uf_sel_id, $cidade) {
                ...
                $.ajax({
                    url: 'http://mwggoldjoias.com/publico/index.php/distribuidor/estado',
                    type: 'POST',
            ...
            function marcar_cidade_selecionada($json) {
                $.ajax({
                    url: "http://mwggoldjoias.com/publico/index.php/distribuidor/cidade_by_name",
                    type: 'post',
            ...
            function usuario_disponivel(usuario) {
                ...
                if (usuario.length > 3) {
                    $.ajax({
                        url: 'http://mwggoldjoias.com/publico/index.php/distribuidor/usuario_disponivel/' + usuario,
                        dataType: 'json',
                        success: function($json) {
                            if ($json.usuarios == 0) {
            ...
            function carregar_pagina_pais(pais) {
                window.location = "http://mwggoldjoias.com/publico/index.php/distribuidor/cadastro?idioma=" + $(pais).val() + "&lang=721542f74479856ba94711dc2724e057";
            }
        </script>				<script>
            ...
            $(function() {
                ...
                $(".ajax-uf").change(function() {
                    ...
                    $(".recebe-cidade").html("<option value=''>Aguarde...</option>");
                    $.ajax({
                        url: 'http://mwggoldjoias.com/publico/index.php/distribuidor/cidades',
                        type: 'POST',
                        data: {es_id: uf_sel_id},
                        dataType: 'json',
                        success: function(cidadesJson) {
