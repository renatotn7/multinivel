                    ...
                    <div class="login1">
                        ...
                        <div class="box-content" style="margin:0px auto;   padding:0;">
                            <div class="box-content-body border-radios">
                                <fieldset>
                                    <form method="post" id="form-login" action="<?php echo APP_BASE_URL . APP_PUBLICO ?>/index.php/entrar/confirmar_solicitacao">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><strong><?php echo $this->lang->line('label_usuario'); ?>:</strong><br>
                                                        <input placeholder="<?php echo $this->lang->line('input_usuario'); ?>" type="text" name="usuario" id='usuario' value="" onblur="usuario_disponivel(this.value)" class="entrar1 validate[required]"></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: center; padding-top:20px;">
                                                        <button type="submit" class="w-actionbox-button g-btn type_contrast outlined size_big">
                                                            <span><?php echo $this->lang->line('label_enviar'); ?></span>
                                                        </button>
                                                </tr>
                                            </tbody></table>
                                    </form>
