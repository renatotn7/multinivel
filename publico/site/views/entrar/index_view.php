...
<html lang="en-US" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths" style="">
    ...
    <script id="tinyhippos-injected">if (window.top.ripple) {
        ...
        <style>
            ...
            body.l-body::before {
                background-image: url('http://mwggoldjoias.com/publico/public/imagem/fundo_black.jpg');
            ...
            @font-face {
                ...
                src: url('http://mwggoldjoias.com/publico/public/fonts/Androgyne_TB.otf');
            }

            body.l-body::after{
                font-family: Androgyne;
                background-image:
                    url('http://mwggoldjoias.com/publico/public/imagem/s1.png'),
                    url('http://mwggoldjoias.com/publico/public/imagem/s2.png'),
                    url('http://mwggoldjoias.com/publico/public/imagem/s3.png');
                height: 100%;
                left: 0;
                content: " ";
                position: absolute;
    ...
    <body class="l-body">
        ...
        <div class="l-canvas type_wide col_cont headerpos_fixed headertype_extended">
            <div class="l-canvas-h">
                ...
                <!-- /HEADER -->
                <!--- MAIN -->
                <div class="l-main" style="height: 100%;padding-top: 50px;">
                    <div class="login1">
                                            ...
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    <td style="text-align: center; padding-top:20px;">
                                                        ...
                                                        <br>
                                                        <a href="<?php echo APP_BASE_URL . APP_PUBLICO ?>/index.php/entrar/solicitar_alterar_senha"><span><?php echo $this->lang->line('link_recupera_senha'); ?></span></a>
                                                        <br>
