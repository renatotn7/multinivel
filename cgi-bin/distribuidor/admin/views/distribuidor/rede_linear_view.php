...
<div class="box-content">
 <div class="box-content-header"><?php echo $this->lang->line('label_meu_titulo');?></div>
 <div class="box-content-body" style="background:#FFF;">
...
<div class="buttons">
 <a class="botao" href="javascript:history.go(-1)"><?php echo $this->lang->line('label_voltar');?></a>
</div>
