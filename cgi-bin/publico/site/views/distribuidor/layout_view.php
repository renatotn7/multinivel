<?php $this->lang->load('publico/distribuidor/layout_view'); ?>
<!DOCTYPE html>
<!-- saved from url=(0045)https://empresa.com/register2/index.html -->
<html lang="en-US" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths" style="">
    ...
    <script id="tinyhippos-injected">if (window.top.ripple) {
        ...
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/css.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/css(1).css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/motioncss.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/motioncss-widgets.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/font-awesome.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/rs-settings.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/rs-captions.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/magnific-popup.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/style.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/responsive.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/animation.css">
        <link rel="stylesheet" type="text/css" media="all" href="<?php echo base_url() ?>public/css/color_0.css">
...
<?php echo $this->lang->line('language_script'); ?>
        ...
        <script type="text/javascript" src="<?php echo base_url() ?>public/script/bootstrap-tooltip.js"></script>
            ...
            $(document).ready(function($) {
                ...
                $("#tolltip")
                        .on('mouseover', function() {
                            $("#mostrarTollTip").fadeIn();
                        })
                        .on('mouseout', function() {
                            $("#mostrarTollTip").fadeOut();
                        });
...
<?php $this->load->view('fixo/topo_view') ?>
                ...
                <div class="l-main">
                    <div class="l-main-h">
<?php isset($pagina) ? $this->load->view("{$pagina}_view") : ""; ?>  
                        <script>
                            ...
                            $(function() {
                                $(".remover-icon").click(function() {
                                    return confirm('<?php echo $this->lang->line('js_confirm'); ?>');
                                });
                                ...
                                $(".ajax-uf").change(function() {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(cidadesJson) {
                                            var txt_cidades = "<option value=''><?php echo $this->lang->line('option_padrao'); ?></option>";
...
<?php //$this->load->view('fixo/rodape_view') ?>
        <!-- /FOOTER -->
        <a class="w-toplink" href="https://empresa.com/register2/index.html#"><i class="fa fa-angle-up"></i></a> 
        <script type="text/javascript">
