<?php $this->lang->load('publico/entrar/nova_solicitacao_view'); ?>
<!DOCTYPE html>
                    ...
                    <div class="login1">
                        ...
                        <div class="box-content" style="margin:0px auto;   padding:0;">
                            <div class="box-content-body border-radios">
                                <fieldset>
                                    <form method="post" id="form-login" action="<?php echo APP_BASE_URL . APP_PUBLICO ?>/index.php/entrar/nova_solicitacao_emial">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><strong><?php echo $this->lang->line('label_usuario'); ?>:</strong><br>
                                                        <input placeholder="<?php echo $this->lang->line('input_usuario'); ?>" type="text" name="usuario" id='usuario' value="<?php echo $distribuidor->di_usuario;?>" ></td>
                                                </tr>
                                                <tr>
                                                    <td><strong><?php echo $this->lang->line('label_email'); ?>:</strong><br>
                                                        <input  type="text" name="email" id='email' value="<?php echo $distribuidor->di_email;?>" ></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: center; padding-top:20px;">
                                                        <button type="submit" class="w-actionbox-button g-btn type_contrast outlined size_big"> 
                                                            <span><?php echo $this->lang->line('label_confirmar'); ?></span> 
                                                        </button>
