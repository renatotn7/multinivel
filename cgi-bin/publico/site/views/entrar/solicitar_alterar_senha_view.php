<?php $this->lang->load('publico/entrar/solicitar_alterar_senha');?>
<!DOCTYPE html>
    ...
    <div class="l-main">
       <div class="l-main-h">
        <div style="padding: 20px 0 0 0; text-align:center;">
          <h2 class="align_center"><strong><?php echo $this->lang->line('conteudo_titulo'); ?></strong></h2>
        </div>
           
          <div class="box-content" style="margin:0px auto; width:940px; padding:0;">
          <div class="box-content-body border-radios">  
          <fieldset>
              <form method="post" id="form" action="<?php echo base_url('index.php/entrar/solicitar_alterar_senha');?>" name="form">
                  <?php if(isset($error)){?> 
                  <div class="alert" style="margin-left: 302px;
                                            color: red;"><?php echo $error?></div>
                        <script type="text/javascript">
                                jQuery(function(){setTimeout('hide_notificacao("#noti_")',6000)});
                        </script>
                  <?php }?>
                  <table align="center"  width="350px" border="0" cellspacing="0" cellpadding="0" style="left: 50%;
                                                                                        margin-left: -157px;
                                                                                        position: relative;
                                                                                        height: 256px;">
                    <center>
			<?php if(isset($_GET['msg']) && $_GET['msg'] !="xvt1"){
			...
			<?php if(isset($_GET['msg']) && $_GET['msg']=="xvt1"){
				echo "<h4  style='color:#f00;'> 
                       ...
                       <tr>
                           <td >
                             <strong><?php echo $this->lang->line('label_usuario'); ?>:</strong><br>
                              <input placeholder="<?php echo $this->lang->line('input_usuario_value'); ?>" type="text"  name="ni" id="usuario_new" value="" onblur="usuario_disponivel(this.value)" class="ni validate[required]">
                          </td>
                        </tr>
                       <tr>
                           <td >
                               <button style="margin-left: 55px;" type="submit" class="w-actionbox-button g-btn type_contrast outlined size_big">
                                    <span><?php echo $this->lang->line('btn_entrar'); ?></span>
                               </button>
                               <br/>
                             <a  href="<?php echo base_url('index.php/entrar/solicitar_alterar_senha')?>"><span><?php echo $this->lang->line('link_recupera_senha'); ?></span></a>
                          </td>
                        </tr>
                  </table>
...
<script>
  ...
  ga('create', 'UA-50099703-1', 'empresa.com');
  ga('send', 'pageview');
