<h1>Cadastro - preencha o formulario com suas informações</h1>
...
<select name="country_id" class="large-field" style="height: 31px;width: 317px">
...
<select name="zone_id" class="large-field" style="height: 31px;width: 317px;">
</select>
<br/>
<br/>
