...
class ControllerAccountOrder extends Controller {
    ...
    public function info() {
        ...
        if ($order_info["payment_method"] == $this->language->get('check_payment_method_name')) {
            $this->data['check_payment_method'] = 1;
        } else {
            $this->data['check_payment_method'] = null;
        }
        ...
        if ($order_info) {
            ...
            $this->data['button_continue'] = $this->language->get('button_continue');
            $this->data['button_rebillet'] = $this->language->get('button_rebillet');
            $this->data['order_status'] = $order_info['order_status_id'];
            ...
            $this->data['rebillet'] = $this->url->link('payment/boletocef/reprint', 'order_id=' . $this->request->get['order_id'], 'SSL');
