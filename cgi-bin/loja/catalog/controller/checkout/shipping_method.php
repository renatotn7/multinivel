...
class ControllerCheckoutShippingMethod extends Controller {
    ...
    public function index() {
        ...
        if (!empty($shipping_address)) {
            ...
            //Verificar se é compra de franquia
            $this->load->model('catalog/planos');
            $temPlano = $this->model_catalog_planos->getTemPlanoDistribuidor($this->customer->getConsultorId());
            $eCompraFranquia = $this->cart->getProductCartFranquia();
            if ($temPlano == false && $eCompraFranquia == true) {
                $this->load->model('checkout/coupon');				
		$coupon_info = $this->model_checkout_coupon->getCoupon('frete');	
                $this->session->data['coupon'] = 'frete';
            }
           ...
           /* if(isset($this->session->data['coupon'])){
               var_dump($this->session->data['coupon']); 
            }*/
