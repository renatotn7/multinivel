        ...
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            ...
            <tr>
              ...
              <td class="right"><input style="display:none;" type="text" name="banner_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>

              <td class="left"><a style="display:none;" onclick="$('#module-row<?php echo $module_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
          ...
          <tfoot>
            ...
            <tr>
              ...
              <td class="left"><a style="display:none;" onclick="addModule();" class="button"><?php echo $button_add_module; ?></a></td>
