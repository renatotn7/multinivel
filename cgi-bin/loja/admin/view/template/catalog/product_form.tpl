          ...
          <div id="language<?php echo $language['language_id']; ?>">
            ...
            <table class="form">
              ...
              <tr>
                ...
                <td><span class="required">*</span><?php echo $entry_meta_keyword; ?></td>
           ...
           <tr>
            ...
            <tr>
              ...
              <td><input type="text" name="price" value="<?php echo $price; ?>" /> 
                  ...
                  <span>Desconto para franqueado<input type="text" name="discount_franq" value="" onblur="addNewSpecial();" />%</span>
                  <?php } ?>
              </td>
            ...
            <tbody id="special-row<?php echo $special_row; ?>">
              ...
              <tr>
                ...
                <td class="right">
                    ...
                    <input type="hidden" name="product_special[<?php echo $special_row; ?>][discount]" value="<?php echo $product_special['discount']; ?>" />
                    <?php echo $product_special['discount']; ?>% de desconto
                </td>
...
function addSpecial() {
	...
	html += '<td class="right">';
	html += '    <input type="text" name="product_special[' + special_row + '][price]" value="" /> = ';
	html += '    <input type="text" name="product_special[' + special_row + '][discount]" value="0" />% de desconto';
	html += '</td>';
...
// já existe var special_row = <?php echo $special_row; ?>;

function addNewSpecial() {

        
        var valProd = $('input[name=\'price\']').val();
        var valDesc = $('input[name=\'discount_franq\']').val();
        var valFinal = valProd*((100-valDesc)/100);
    ...
    <?php foreach ($customer_groups as $customer_group) { ?>
        if(<?php echo $customer_group['customer_group_id']; ?>==3){
    ...
    html += '    <td class="right"><input type="text" name="product_special[' + special_row + '][priority]" value="1" size="2" /></td>';

	html += '    <td class="right">';
	html += '    <input type="text" name="product_special[' + special_row + '][price]" value="' + valFinal + '" /> = ';
	html += '    <input type="hidden" name="product_special[' + special_row + '][discount]" value="' + valDesc + '" />' + valDesc + '% de desconto';
	html += '</td>';

    html += '    <td class="left"><input type="text" name="product_special[' + special_row + '][date_start]" value="<?php echo date('Y-m-d');?>" class="date" /></td>';

	html += '    <td class="left"><input type="text" name="product_special[' + special_row + '][date_end]" value="0000-00-00" class="date" /></td>';
	...
	special_row++;
        //$('input[name=\'discount_franq\']').attr('disabled',true);
