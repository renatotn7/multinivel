...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="heading">
      ...
      <div style="display:none;" class="buttons"><a onclick="location = '<?php echo $insert; ?>'" class="button"><?php echo $button_insert; ?></a><a onclick="$('form').submit();" class="button"><?php echo $button_delete; ?></a></div>
