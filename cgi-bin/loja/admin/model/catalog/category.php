...
class ModelCatalogCategory extends Model {
	...
	public function addCategory($data) {
		...
		//Inserir descrição das categorias 
		$inseriu_seo_slug = false;
		foreach ($data['category_description'] as $language_id => $value) {
		   ...
		   //inserir url amigave
		  if(!$inseriu_seo_slug){
		  $data['keyword'] = $data['keyword']?$data['keyword']:$value['name'];
		  $this->url->inserir_slug($this->db,$this->db->escape($data['keyword']),"category_id=" . (int)$category_id);
		  $inseriu_seo_slug = true; 
		  }
		  //FIm inserir url amigavel
		}
	...
	function prepara_slug($str){
	 $acentos = array(
			...
			$ja_existe =  $this->db->query("SELECT * FROM ".DB_PREFIX."url_alias WHERE keyword = '$slung'");
