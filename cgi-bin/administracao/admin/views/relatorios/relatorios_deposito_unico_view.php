...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td>
     <strong><?php echo $dep[0]->di_nome?></strong><br />
    ...
    <td width="30%">
     ...
     <b>Situação:</b> <?php echo $dep[0]->cdp_status==1?'<a href="'.base_url("index.php/deposito/status?cdp={$dep[0]->cdp_id}&s=0").'">Depositado</a>'
   :'<a href="'.base_url("index.php/deposito/status?cdp={$dep[0]->cdp_id}&s=1").'">Aguardando depósito</a>'?>
    </td>
  </tr>
</table>
<br />
...
<table width="100%" class="table" border="0" cellspacing="0" cellpadding="0">
  <tr class="title">
    <td><strong>Conta para depósito</strong></td>
  </tr>
  <tr>
    <td>
