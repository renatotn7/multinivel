            ...
            <table width="100%" class="table table-hover table-bordered" border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <div class="btn-toolbar" style="margin: 0;">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <?php } ?>
                                        <?php if (Distribuidores::status_financeiro($d->di_usuario)) { ?>    
                                            <li>
                                                <a  onclick="return confirm('Deseja bloquear o usuário: <?php echo $d->di_usuario; ?>?');" href="<?php echo base_url('index.php/distribuidores/bloquear_desbloquear_financeiro/' . $d->di_usuario); ?>"><i class="icon-ban-circle"></i> Bloquear financeiro</a>
                                            </li>
                                        <?php } else { ?>
                                            <li>
                                                <a  onclick="return confirm('Deseja desbloquear o usuário: <?php echo $d->di_usuario; ?>?');" href="<?php echo base_url('index.php/distribuidores/bloquear_desbloquear_financeiro/' . $d->di_usuario); ?>"><i class="icon-ban-circle"></i> Desbloquear financeiro</a>
                                            </li>
                                        <?php } ?>    
                                        <li>
                        ...
                        <td><?php echo $d->co_forma_pgt_txt; ?></td>
                        <td>
                            <?php
