...
<table width="400px" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div class="alert alert-error" style="width:100px;">
     <input style="margin:0; padding:0;" type="radio" name="cor" <?php echo $d->cor=='alert-error'?'checked':''?> value="alert-error" /> Importante
    </div>
    </td>
    ...
    <div class="alert" style="width:100px;">
     <input style="margin:0; padding:0;" type="radio" name="cor" value="alert" <?php echo $d->cor=='alert'?'checked':''?> /> Alerta
    </div>
