...
class CI_DB_active_record extends CI_DB_driver {
	...
	function insert($table = '', $set = NULL)
	{
		...
		$sql = $this->_insert($this->_protect_identifiers($table, TRUE, NULL, FALSE), array_keys($this->ar_set), array_values($this->ar_set));
                $this->auditoria_geral($this->ar_set, $table,'Inclusao');
	...
	public function update($table = '', $set = NULL, $where = NULL, $limit = NULL)
	{
		...
		$sql = $this->_update($this->_protect_identifiers($table, TRUE, NULL, FALSE), $this->ar_set, $this->ar_where, $this->ar_orderby, $this->ar_limit);
                $select =  str_replace('`','',implode(',',  array_keys($this->ar_set)));
                //Auditoria geral
                $dados_anterio = $this->where(implode('',$this->ar_where))->select($select)->get($table)->row();
                $this->auditoria_geral($this->ar_set, $table,'Atualizacao',$dados_anterio);
	...
	public function delete($table = '', $where = '', $limit = NULL, $reset_data = TRUE)
	{
		...
		$sql = $this->_delete($table, $this->ar_where, $this->ar_like, $this->ar_limit);
                ...
                //Auditoria.
                $dados_anterio = $this->where(implode(' ',$this->ar_where))->get($table)->row();
                $this->auditoria_geral(array(), str_replace('`', '', $table),'Remocao',$dados_anterio);
