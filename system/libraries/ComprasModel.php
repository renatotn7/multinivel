...
class ComprasModel {
    ...
    public static function addCompraAtivacao($idDistribuidor = 0) {
        ...
        $produto_ativacao = $produto_ativacao[0];
        
        //Se não for de ativação então não continua.
        if ($produto_ativacao->pr_ativacao == 0) {
            return array();
        }
        ...
        get_instance()->db->insert('compras', array(
            ...
            'co_total_valor' => $produto_ativacao->pr_valor * 1,//$compraAtivacaoMensal->pm_quantidade
        ));
        ...
        get_instance()->db->insert('produtos_comprados', array(
            ...
            'pm_id_produto' => $produto_ativacao->pr_id,
            'pm_quantidade' => 1,
            'pm_pontos' => 0,
            'pm_valor' => $produto_ativacao->pr_valor - $produto_ativacao->pr_desconto_distribuidor,
            'pm_valor_total' => $produto_ativacao->pr_valor
        ));
