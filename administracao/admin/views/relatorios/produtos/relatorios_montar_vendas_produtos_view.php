...
<form name="formulario" target="_blank" action="<?php echo base_url('index.php/relatorios/relatorio_produto/')?>" 
method="get">
...
até: <input type="text" class="mdata" size="10" style="width:90px;" value="<?php echo date('d/m/Y')?>" name="ate" />
</p>
...
<a class="btn" href="<?php echo base_url('index.php/relatorios/')?>">Voltar</a>
</form>
