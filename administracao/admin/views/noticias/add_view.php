...
<table width="400px" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <div class="alert alert-error" style="width:100px;">
     <input style="margin:0; padding:0;" type="radio" name="cor" value="alert-danger" /> Importante
    </div>
    </td>
    ...
    <div class="alert" style="width:100px;">
     <input style="margin:0; padding:0;" type="radio" name="cor" value="alert-warning" /> Alerta
    </div>
