...
")->result();
?>
<?php if(get_user()->di_data_cad <='2014-04-01 00:00:00'){ ?>
	<h2>
	...
	<div>
		<?php echo str_replace('{numero}', '<b>'.  conf()->numero_transferencia_diaria.'.</b>', str_replace('{taxa}','<b>'.  conf()->taxa_transferecia_entre_usuario.'%</b>' , $string =$this->lang->line('notificaton_transferencia')));?>
	</div>
	<hr />
	...
	<form id="form1" name="form1" method="post" action="<?php echo base_url('index.php/bonus/transferir_usuario')?>">
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<tr>
				...
				<td width="22%">
					<?php echo $this->lang->line('label_us$');?> <?php echo number_format($saldo[0]->saldo,2,',','.')?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="text" name="valor" style="width:100px; text-align:right; font-size:18px;" class="moeda" value="0,00" />
				</td>
			</tr>
			<tr>
