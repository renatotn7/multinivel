...
<form onSubmit="return valida()" action="<?php echo base_url('index.php/mensagem/escrever')?>" method="get" name="formulario">
...
function marcar_escolhido(id,nome){
	...
	$('input[name="ni"]').val(id);
	
	
	var html_confirm = "<h4 style='margin:3px;'>A Mensagem será enviada para:</h4>";
