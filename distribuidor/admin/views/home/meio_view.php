...
?>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="noticias-home alert alert-danger">
    ...
    <div class="panel panel-default">
        ...
        <?php if (get_user()->distribuidor->getAtivo() == 0) { ?>
            ...
            <div class="menu_option" align="center">
                <a href="#" target="_self" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_banco')); ?>" />
                    <i class="fa fa-bank"></i>
                    <span><?php echo $this->lang->line('label_banco'); ?></span>
                </a>
            </div>

            <div class="menu_option" align="center">
                <a href="#" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_saque')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_saque'); ?></span>
                </a>
            </div>

           <!--  <div class="menu_option" align="center">
                <a href="#" target="_self" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_trainamentos')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_trainamentos'); ?></span>
                </a>
            </div>

            <div class="menu_option" align="center">
                <a  href="#" target="_self" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_download')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_download'); ?></span>
                </a>
            </div>
            <div class="menu_option" align="center">
                <a href="#" target="_self" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_suporte')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_suporte'); ?></span>
                </a>
            </div> -->
            <div class="menu_option" align="center" style="width: 114px;">
                <a href="#" target="_self"  class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $url_chat); ?>" />
                    <i class="fa fa-shopping-cart"></i>
                    <span><?php echo $this->lang->line('label_comprar_evooucher'); ?></span>
                </a>
            </div>

            <?php
            $pais = $this->db->where('ci_id', get_user()->di_cidade)->get('cidades')->row();
            $cartao_atm = $this->db->where('ccm_niv', get_user()->di_niv)->get('compra_cartao_memberships')->row();

            if (count($cartao_atm) == 0 && !empty(get_user()->di_niv) && get_user()->di_data_cad > '2014-04-01 23:59:59') {
            ?>
            <!-- <div class="menu_option" align="center">
                <a href="<?php echo base_url('index.php/comprar_cartao'); ?>" target="_self"  class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $url_chat); ?>" />
                    <i class="fa fa-shopping-cart"></i>
                    <span><?php echo $this->lang->line('label_comprar_evooucher'); ?></span>
                </a>
            ...
            <?php } ?>
            <!-- <div class="menu_option" align="center">
                <a href="http://www.empresashop.com" target="_blank" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/carrinho-ew.jpg'); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php // echo $this->lang->line('label_chat'); ?></span>
                </a>
            </div> -->
        <?php } else { ?>
            <div class="menu_option" align="center">
                <a href="<?php echo base_url('index.php/distribuidor/meus_dados') ?>" class="btn btn-app">
                    <i class="fa fa-user"></i>
                    <span><?php echo $this->lang->line('label_minha_conta'); ?></span>
                </a>
            </div>
            <!--CONTINUAR APARTIR DAQUI-->
            <div class="menu_option" align="center">
                <a href="<?php echo base_url('index.php/bonus/extrato') ?>" class="btn btn-app">
                    <i class="fa fa-bank"></i>
                    <span><?php echo $this->lang->line('label_banco'); ?></span>
                </a>
            </div>
            ...
            <div class="menu_option" align="center">
                <a href="<?php echo base_url("index.php/bonus/extrato"); ?>" class="btn btn-app">
                    ...
                    <span class="glyphicon-class"><?php echo $this->lang->line('label_saque'); ?></span>
                </a>
            </div>
            <?php } ?>

            <?php if(get_user()->di_id == 18){ ?>
            <div class="menu_option" align="center">
                <a href="<?php echo base_url('index.php/loja/opcao_pagamento') ?>" class="btn btn-app">
                    <span class="glyphicons glyphicons-usd" aria-hidden="true"></span>
                    <span class="glyphicon-class"><?php echo $this->lang->line('label_pagar'); ?></span>
                </a>
            </div>
            <?php } ?>

            <!-- <a href="#"> <img src="<?php // echo base_url('public/imagem/links-home/' . $this->lang->line('url_att_bonus')); ?>" />
            </a>-->
            ...
            <!--  <div class="menu_option" align="center">
                <a href="<?php echo $this->lang->line('url_noticias_treinamentos'); ?>" target="_blank" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_trainamentos')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_trainamentos'); ?></span>
                </a>
            ...
            <div class="menu_option" align="center">
                <a  href="<?php echo $this->lang->line('url_pagina_download'); ?>" target="_blank" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_download')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_download'); ?></span>
                </a>
            ...
            <div class="menu_option" align="center">
                <a href="http://www.empresa.com/ticket/" target="_blank" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_suporte')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_suporte'); ?></span>
                </a>
            ...
            <div class="menu_option" align="center">
                <a href="<?php echo $link_click_friend; ?>" target="_blank">
                    <img style="float:left;" src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_comprar_click_friends')); ?>" />
                    <i class="fa fa-shopping-cart"></i>
                    <span style="font-size: 12px;float:left;"><?php echo $this->lang->line('label_comprar_click_friends'); ?></span>
                </a>
            </div>
            <?php } ?>
            ...
            <!-- <div class="menu_option" align="center">
                <a href="<?php echo base_url('index.php/distribuidor/upgrade_plano'); ?>" target="_self" class="btn btn-app">
                    <img src="<?php echo base_url('public/imagem/links-home/png/' . $this->lang->line('url_upgrade')); ?>" />
                    <i class="fa fa-users"></i>
                    <span><?php echo $this->lang->line('label_upgrade'); ?></span>
                </a>
            </div> -->
            <?php } ?>
...
if (count($primeiraCompra) == 0) {
    if (count($compraNaoPaga) > 0) {
        $this->load->view('home/informacao_cartao_intercash_view', array('compraNaoPaga' => $compraNaoPaga));
    } else {
